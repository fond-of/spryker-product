...
{
    /**
     * @var \Spryker\Zed\Product\Dependency\Facade\ProductToStoreInterface $storeFacade
     */
    protected ProductToStoreInterface $storeFacade;

    /**
     * @var \FondOfSpryker\Zed\Product\Dependency\Facade\ProductToUrlInterface $urlFacade
     */
    protected $urlFacade;


    /**
     * @var \FondOfSpryker\Zed\Product\Persistence\ProductQueryContainerInterface $productQueryContainer
     */
    protected $productQueryContainer;

    /**
     * @param \FondOfSpryker\Zed\Product\Dependency\Facade\ProductToUrlInterface $urlFacade
     ...
     */
    public function createProductUrl(ProductAbstractTransfer $productAbstractTransfer): ProductUrlTransfer
    {
     ...
     */
    protected function getUrlByIdProductAbstractIdStoreAndIdLocale(int $idProductAbstract, int $idStore, int $idLocale): UrlTransfer
    {
